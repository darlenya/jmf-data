...
/**
 * This handler creates the data model for graphql.
 * The eventhandler will be called when the input model is parsed
 */
export default class DataEventHandler extends DefaultEventHandler {
